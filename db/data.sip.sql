...
(
    ...
    sumber_dana_string character varying(255) COLLATE pg_catalog."default" DEFAULT NULL::character varying,
    mak character varying(255) COLLATE pg_catalog."default" DEFAULT NULL::character varying,
    pagu_mak character varying(255) COLLATE pg_catalog."default" DEFAULT NULL::character varying,
...
CREATE TABLE sip.tbl_pkt_penyedia_belum(
		...
		mak character varying(255) DEFAULT NULL,
		pagu character varying(255) DEFAULT NULL,
		status numeric(1,0) DEFAULT 0 NOT NULL,
		total_pagu character varying(20) DEFAULT NULL,
		deskripsi character varying(255) DEFAULT NULL,
