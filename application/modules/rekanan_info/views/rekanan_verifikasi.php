    ...
    <div class="card">
        ...
        <div class="card-block">
            <div class="table-responsive">
                <table class="rekanan-info-rekanan-verifikasi-table table table-hover">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
...
<script type="text/javascript">
    ...
    //*                                             
    //*****************************************************
    create_rekanan_info_rekanan_verifikasi(
                                                    jQuery(".rekanan-info-pencarian-data-tahun").val()
                                                );
    function refresh_rekanan_info_rekanan_verifikasi(tahun){
        create_rekanan_info_rekanan_verifikasi(tahun);
    }

    function data_rekanan_info_rekanan_verifikasi(tahun){
        var data = null;
        jQuery.ajax({
          type      : 'AJAX',
          method    : 'GET',
          url       : '../rekanan/info/data/rekanan-verifikasi/'+tahun,
          async     : false,
          dataType  : 'JSON',
    ...
    function create_rekanan_info_rekanan_verifikasi(tahun){
        var get_data = data_rekanan_info_rekanan_verifikasi(tahun);
        var data_baris = [];
        var data_total = [];
        ...
        jQuery(".rekanan-info-rekanan-verifikasi-table").DataTable({
            destroy         : true,
            processing      : true,
            lengthMenu      : [10],
            dom             : 'Bfrtip',
